    ...
    return (
      <div className="appContent" detailview={detailview}>
        <div className="overviewWrap">
          <Overview phases={blueprintPhases} callbackFromParent={getTimeFrames} toggleView={moveSlidesInView}></Overview>
        ...
        <Router>
          <ul>
            <li><Link className="phaseNavigation" onClick={toOverview} to="/#overview">Overview</Link></li>
          {blueprintPhases.map(phase => (
            <li className="phaseNavigationItem" key={phase.phaseTitle} phaseid={phase.id}>
              <a className="phaseNavigation" onClick={moveSlidesInView} href={'#' + slugify(phase.phaseTitle)}>{phase.phaseTitle}</a>
            </li>
          ))}
          </ul>
          </Router>
          ...
          {blueprintPhases.map(phase => (
            <div key={phase.id} phaseid={phase.id}  data-hash={slugify(phase.phaseTitle)}>
              ...
              <div className="phaseContentWrap">
                ...
                <div className="phaseDataWrap">
                  <Checklist phase={phase.phaseTitle} tasks={phase.measureOfSuccessDefaults}></Checklist>
